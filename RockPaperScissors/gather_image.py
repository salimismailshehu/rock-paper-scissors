...
try:
    ...
    print("{} Diretory alread exists." .format(IMG_CLASS_PATH))
    print("All imagee gather will be saved along with existing itmes in this folder")
...
while True:
    ...
    cv2.putText(frame, "colleting {}" .format(count),
